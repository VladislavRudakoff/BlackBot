namespace FluentBot.Domain.UseCases;

/// <summary>
/// Модель для отправки ответа на <see cref="FluentBot.Domain.Entities.Keyboard.CallbackQuery"/>, отправленные с <see cref="FluentBot.Domain.Entities.Keyboard.InlineKeyboardMarkup"/>.
/// </summary>
